...
BONDS_MM = [
    # USD
    ("US900123CK49",  99.988),
    ("US900123CL22", 100.439),
    ("USM88269US88", 103.173),
    ("US900123DF45", 106.069),
    ("US900123CP36",  99.326),
    ("US900123CQ19", 100.746),
    ("US900123DH01", 107.489),
    ("US900123CT57", 104.124),
    ("US900123AL40", 117.269),
    ("US900123CY43",  96.748),
    ("US900123DJ66", 109.484),
    ("US900123DA57",  97.884),
    ("US900123DV94",  99.055),
    ("US900123DC14",  96.955),
    ("US900123DP27", 101.471),
    ("US900123DL13", 101.090),
    ("US900123DG28", 112.235),
    ("US900123DT49",  96.394),
    ("US900123DD96",  97.002),
    ("US900123AT75", 105.164),
    ("US900123DK30", 102.856),
    ("US900123DN78",  95.302),
    ("US900123DR82",  97.720),
    ("US900123AY60",  96.793),
    ("US900123DS65",  95.673),
    ...
    # EUR
    ("XS2361850527",  99.976),
    ("XS2790222116", 104.240),
    ("XS3123715297", 101.759),
    ("XS3293834662", 100.929),
]
...
def _mm_run():
    ...
    for isin, mid in BONDS_MM:
        ...
        t.start()
        time.sleep(0.15)  # staggered start
